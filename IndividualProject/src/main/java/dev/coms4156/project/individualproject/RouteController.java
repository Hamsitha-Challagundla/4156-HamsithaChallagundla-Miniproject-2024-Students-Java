...
public class RouteController {
  ...
  public ResponseEntity<?> addMajorToDept(@RequestParam("deptCode") String deptCode) {
    try {
      ...
      if (doesDepartmentExists) {
        ...
        return new ResponseEntity<>(
            "Major was added to the department " + deptCode + " successfully", HttpStatus.OK);
      }
      return new ResponseEntity<>("Department Not Found", HttpStatus.NOT_FOUND);
    } catch (Exception e) {
      return handleException(e);
  ...
  public ResponseEntity<?> removeMajorFromDept(@RequestParam("deptCode") String deptCode) {
    try {
      ...
      if (doesDepartmentExists) {
        ...
        return new ResponseEntity<>(
            "Major was removed from the department " + deptCode + " successfully", HttpStatus.OK);
      }
      return new ResponseEntity<>("Department Not Found", HttpStatus.NOT_FOUND);
    } catch (Exception e) {
      return handleException(e);
  ...
  public ResponseEntity<?> dropStudentFromCourse(@RequestParam("deptCode") String deptCode,
                                                 @RequestParam("courseCode") int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
      ...
      if (doesCourseExists) {
        ...
        if (isStudentDropped) {
          ...
          return new ResponseEntity<>("Student has not been dropped. 0 students found",
  ...
  /**
   * Attempts to set the student enrollment count to a specific course.
   *
   * @param deptCode   A {@code String} representing the department.
   * @param courseCode A {@code int} representing the course within the department.
   * @param count      A {@code int} the new time for the course
   * @return A {@code ResponseEntity} object containing an HTTP 200
   *     response with an appropriate message or the proper status
   *     code in tune with what has happened.
   */
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam("deptCode") String deptCode,
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>(
            "EnrollmentCount for course " + courseCode + " was updated successfully.",
            HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
  ...
  public ResponseEntity<?> changeCourseTime(@RequestParam("deptCode") String deptCode,
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>("CourseTime for " + courseCode + " was updated successfully.",
            HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
  ...
  public ResponseEntity<?> changeCourseTeacher(@RequestParam("deptCode") String deptCode,
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>(
            "CourseTeacher for " + courseCode + " was updated successfully.", HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {
  ...
  public ResponseEntity<?> changeCourseLocation(@RequestParam("deptCode") String deptCode,
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>(
            "CourseLocation for " + courseCode + " was updated successfully.", HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {
  ...
  private ResponseEntity<?> handleException(Exception e) {
    ...
    e.printStackTrace();
    return new ResponseEntity<>("An Error has occurred: " + e.getMessage(),
