...
public class RouteController {
  ...
  public ResponseEntity<?> retrieveDepartment(@RequestParam("deptCode") String deptCode) {
    try {
      ...
      if (!departmentMapping.containsKey(deptCode.toUpperCase(Locale.US))) {
        ...
        return new ResponseEntity<>(departmentMapping.get(deptCode.toUpperCase(Locale.US)).toString(),
            HttpStatus.OK);
      }
  ...
  public ResponseEntity<?> retrieveCourse(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
  ...
  public ResponseEntity<?> isCourseFull(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
      ...
      if (doesCourseExists) {
        ...
        if (requestedCourse.isCourseFull()) {
          return new ResponseEntity<>("The course " + courseCode + " is full", HttpStatus.OK);
        } else {
          return new ResponseEntity<>("The course " + courseCode + " is not full", HttpStatus.OK);
        }
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
  ...
  public ResponseEntity<?> getMajorCountFromDept(@RequestParam("deptCode") String deptCode) {
    try {
      boolean doesDepartmentExists = retrieveDepartment(deptCode).getStatusCode() == HttpStatus.OK;
      if (doesDepartmentExists) {
        Map<String, Department> departmentMapping;
  ...
  public ResponseEntity<?> findCourseLocation(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> findCourseInstructor(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> findCourseTime(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> addMajorToDept(@RequestParam("deptCode") String deptCode) {
    try {
      ...
      if (doesDepartmentExists) {
        ...
        specifiedDept.increaseMajorsByOne();
        return new ResponseEntity<>("Major was added to the department " + deptCode + " successfully", HttpStatus.OK);
      }
      return new ResponseEntity<>("Department Not Found", HttpStatus.NOT_FOUND);
    } catch (Exception e) {
      return handleException(e);
  ...
  public ResponseEntity<?> removeMajorFromDept(@RequestParam("deptCode") String deptCode) {
    try {
      ...
      if (doesDepartmentExists) {
        ...
        Department specifiedDept = departmentMapping.get(deptCode);
        specifiedDept.decreaseMajorsByOne();
        return new ResponseEntity<>("Major was removed from the department " + deptCode + " successfully", HttpStatus.OK);
      }
      return new ResponseEntity<>("Department Not Found", HttpStatus.NOT_FOUND);
    } catch (Exception e) {
      return handleException(e);
  ...
  public ResponseEntity<?> dropStudent(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
      ...
      if (doesCourseExists) {
        ...
        if (isStudentDropped) {
          ...
          return new ResponseEntity<>("Student has not been dropped. 0 students found", HttpStatus.BAD_REQUEST);
        }
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode, @RequestParam("count") int count) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>(
            "EnrollmentCount for course " + courseCode + " was updated successfully.", HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {
  ...
  public ResponseEntity<?> changeCourseTime(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode, @RequestParam("time") String time) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>("CourseTime for " + courseCode + " was updated successfully.", HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {
  ...
  public ResponseEntity<?> changeCourseTeacher(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode, @RequestParam("teacher") String teacher) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>("CourseTeacher for " + courseCode + " was updated successfully.", HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {
  ...
  public ResponseEntity<?> changeCourseLocation(@RequestParam("deptCode") String deptCode, @RequestParam("courseCode") int courseCode, @RequestParam("location") String location) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>("CourseLocation for " + courseCode + " was updated successfully.", HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {
